...
const toneConfig = {
  neutral: {
    badge: "bg-slate-500/10 text-slate-700 border border-slate-500/20 backdrop-blur-md",
  ...
  success: {
    badge: "bg-emerald-500/10 text-emerald-700 border border-emerald-500/20 backdrop-blur-md",
    stat: "border-emerald-200/50 bg-emerald-50/40 backdrop-blur-lg shadow-[0_4px_20px_-4px_rgba(16,185,129,0.1)]",
    value: "bg-clip-text text-transparent bg-gradient-to-br from-emerald-600 to-teal-500",
    indicator: "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)]",
  },
  warning: {
    badge: "bg-amber-500/10 text-amber-700 border border-amber-500/20 backdrop-blur-md",
    stat: "border-amber-200/50 bg-amber-50/40 backdrop-blur-lg shadow-[0_4px_20px_-4px_rgba(245,158,11,0.1)]",
    value: "bg-clip-text text-transparent bg-gradient-to-br from-amber-600 to-orange-500",
    indicator: "bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.6)]",
  },
  danger: {
    badge: "bg-rose-500/10 text-rose-700 border border-rose-500/20 backdrop-blur-md",
    stat: "border-rose-200/50 bg-rose-50/40 backdrop-blur-lg shadow-[0_4px_20px_-4px_rgba(244,63,94,0.1)]",
    value: "bg-clip-text text-transparent bg-gradient-to-br from-rose-600 to-red-500",
...
export function StatCard({
  ...
  return (
    ...
    >
      ...
      <small className="text-[11px] font-medium text-slate-500 mt-0.5">{detail}</small>
    </div>
  );
}
