...
const toneConfig = {
  neutral: {
    ...
    stat: "border-white/40 bg-white/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]",
  ...
  success: {
    ...
    stat: "border-emerald-200/50 bg-emerald-50/40 shadow-[0_4px_20px_-4px_rgba(16,185,129,0.1)]",
    value:
  ...
  warning: {
    ...
    stat: "border-amber-200/50 bg-amber-50/40 shadow-[0_4px_20px_-4px_rgba(245,158,11,0.1)]",
    value:
  ...
  danger: {
    ...
    stat: "border-rose-200/50 bg-rose-50/40 shadow-[0_4px_20px_-4px_rgba(244,63,94,0.1)]",
    value:
...
export function StatCard({
  ...
  return (
    <div
      className={`dashboard-stat relative flex flex-col gap-1 p-5 rounded-2xl border shadow-sm hover:shadow-md transition duration-200 hover:-translate-y-0.5 ${cfg.stat}`}
    >
      {icon && (
